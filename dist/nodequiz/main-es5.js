...
var QuizPresentationsComponent = /** @class */ (function () {
    function QuizPresentationsComponent(route, http, router) {
        var _this = this;
        this.route = route;
        this.http = http;
        this.router = router;
        ...
        this.http.get('/api/quizzes/' + this.urlParamId).subscribe(function (res) {
            if (res) {
                return _this.quiz = res;
            }
            else {
                return _this.errorMessage = "WELCOME TO THE LAND OF NO QUIZZES";
            }
        });
    }
    QuizPresentationsComponent.prototype.goToQuizPage = function (id) {
        this.router.navigateByUrl('/quiz-selection/quiz/' + id);
    };
    QuizPresentationsComponent.prototype.ngOnInit = function () {
    };
    QuizPresentationsComponent.ctorParameters = function () { return [
    ...
    return QuizPresentationsComponent;
}());
...
var QuizSelectionComponent = /** @class */ (function () {
    function QuizSelectionComponent(router, http) {
        this.router = router;
        this.http = http;
    }
    QuizSelectionComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('/api/quizzes/all').subscribe(function (res) {
            if (res) {
                return _this.quizzes = res;
            }
            else {
                return _this.errorMessage = "You have traveled to the realm of no quizzes";
            }
        });
    };
    QuizSelectionComponent.prototype.goToPresentationPage = function (id) {
        this.router.navigateByUrl('/quiz-selection/quiz-presentations/' + id);
    };
    QuizSelectionComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
    ]; };
...
var SigninComponent = /** @class */ (function () {
    function SigninComponent(router, cookie, fb, http) {
        this.router = router;
        this.cookie = cookie;
        this.fb = fb;
        this.http = http;
    ...
    SigninComponent.prototype.submit = function () {
        ...
        this.http.get('/api/employees/' + employeeId).subscribe(function (res) {
            if (res) {
                ...
                _this.router.navigate(['/quiz-selection']);
            }
            else {
                _this.errorMessage = "Please try again";
            }
        });
    };
